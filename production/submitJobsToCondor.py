...
if __name__ == '__main__':
    ...
    parser.add_argument('--mnlsp', help="NLSP mass", type=int, default=800)
    parser.add_argument('--mlsp',  help="LSP mass", type=int, default=1)
    ...
    label = 'WH_had_%s_%s'%(MNLSP, MLSP)

    script_dir = os.path.dirname(os.path.realpath(__file__))

    out_dir='/hadoop/cms/store/user/'+os.environ['USER']+'/WH_hadronic'
    ...
    for j in range(0,njobs):
        ...
        options = [str(MNLSP), str(MLSP), str(nevents), str(rseed), outdir]
